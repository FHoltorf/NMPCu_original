...
cons = ['PO_ptg','unsat','mw','mw_ub','temp_b','T_max']#,'T_min','mw']
...
alpha = 0.2
alpha_1 = 0.2
dummy ={(1, 2): {('A', ('p',)): 1-alpha_1, ('kA', ()): 1-alpha, ('A', ('i',)): 1-alpha},#, ('T_ic', ()): 1+0.005, ('MY_ic', ()): 1+0.01, ('PO_ic', ()): 1+0.02}, 
         (1, 3): {('A', ('p',)): 1-alpha_1, ('kA', ()): 1+alpha, ('A', ('i',)): 1-alpha},#, ('T_ic', ()): 1-0.005, ('MY_ic', ()): 1-0.01, ('PO_ic', ()): 1+0.02}, 
...
for i in range(1,nfe):
    ...
    if i == 1:
        ...
        e.SBWCS_hyrec(epc=cons[:4], pc=cons[4:],par_bounds=p_bounds,crit='con',noisy_ics=noisy_ics)

...
#        self.scale = 1
        ...
        def _ode_T_cw(self,i,j):    
            if j > 0:
                ...
                return self.dT_cw_dt[i,j] == (self.D[i]*self.tf*(self.T_cw_in*self.T_scale - self.T_cw[i,j]*self.T_scale) + self.Qc[i,j]*self.Hrxn['p']/(self.m_cw*self.cp_cw))/self.T_scale
            else:
                return Constraint.Skip

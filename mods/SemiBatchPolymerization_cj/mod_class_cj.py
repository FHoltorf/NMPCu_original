...
class SemiBatchPolymerization(ConcreteModel):
    def __init__(self, nfe, ncp, **kwargs):        
        ...
        # heat transfer
        self.kA = Var(initialize=2200.0/self.Hrxn['p']*60.0/20.0) # 
        self.kA.fix()
        ...
        self.Y = Var(self.fe_t,self.cp, initialize=self.Y_ic, bounds=(0.0,None)) # unsaturaed by-product
        ...
        self.G = Var(self.fe_t,self.cp,bounds=(0.0,None)) #
